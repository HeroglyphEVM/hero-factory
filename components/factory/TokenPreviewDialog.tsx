  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Token Preview</DialogTitle>
          <DialogDescription>Review your token details before deployment</DialogDescription>
        </DialogHeader>
        <div className="py-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <PreviewInfoItem
              label="Max Bonus Reward"
              value={formData.maxBonusRewardAfterOneDay || '0'}
            />
            <PreviewInfoItem
              label="Pre-Mint Amount"
              value={formData.preMintAmount || '0'}
              colSpan={2}
            />
            {formData.isPro && (
              <>
