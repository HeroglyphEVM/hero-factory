...
export const TokenSettingsGraffiti: React.FC<TokenSettingsFormProps> = ({ tokenData }) => {  
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await triggerGraffiti({ 
        ...
        args: [validatorWithdrawer as Address, tokenData.address as Address]
      })
    } catch (error: any) {
  ...
  return (
    <Card className="mb-6">
      ...
      <CardDescription>
         Only for testing. This will trigger a graffiti on the token contract.
        </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-2">
            <div className="flex space-x-2">
              <Input
                ...
                placeholder="Validator withdrawer address"
