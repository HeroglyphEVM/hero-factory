...
export const TokenSettingsTrigger: React.FC<TokenSettingsFormProps> = ({ tokenData }) => {
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>Update Trigger Contract</CardTitle>
        <CardDescription>
         Warning: This will break the token contract if set incorrectly. Please review docs before updating
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isTriggerLoading ? (
